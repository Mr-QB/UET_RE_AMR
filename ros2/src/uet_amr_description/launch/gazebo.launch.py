...
def generate_launch_description():
    ...
    world_file = os.path.join(pkg_ros_gz_rbot, 'worlds', 'test_place.sdf')
    
    robot_description_config = xacro.process_file(robot_description_file)
    robot_description = {'robot_description': robot_description_config.toxml()}

    # Khởi chạy node công bố trạng thái các khớp
    ...
    # Khởi chạy node điều khiển 2 bánh
    ...
    return LaunchDescription([
        ...
        load_joint_state_broadcaster, # Thêm dòng này
        load_diff_drive_controller,   # Thêm dòng này
    ])
